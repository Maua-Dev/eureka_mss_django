        ...
        self.alb_fargate_service = ecs_patterns.ApplicationLoadBalancedFargateService(
            ...
            task_image_options=ecs_patterns.ApplicationLoadBalancedTaskImageOptions(
                ...
                environment={
                    ...
                    "DB_USER": rds_cluster.secret.secret_value_from_json("username").unsafe_unwrap(),
                    "DB_PASSWORD": rds_cluster.secret.secret_value_from_json("password").unsafe_unwrap(),
                    "DB_HOST": rds_cluster.instance_endpoints[0].hostname,
                    "DB_PORT": rds_cluster.instance_endpoints[0].port,
